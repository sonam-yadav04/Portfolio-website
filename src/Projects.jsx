...
const projects = [
  ...
  },
  {
    ...
    tech: 'React.js, Redux, Hooks, OpenLibrary API, CSS',
    description: 'Book finder app where you can search and find any book from around the world using the author name, title, subject, or ISBN.',
  ...
  return (
    <section id="projects" className="section">
      <div className="section-content">
        <p className="section-eyebrow mono">// 02 projects</p>
